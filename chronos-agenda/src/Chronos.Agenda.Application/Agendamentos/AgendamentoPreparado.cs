...
/// <summary>Dados já validados e prontos para criar ou reagendar um agendamento (RN04, RN05, RN06), antes das
/// checagens de disponibilidade (RN07) e conflito de agenda (RN02).</summary>
